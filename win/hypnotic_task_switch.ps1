...
$taskAction = New-ScheduledTaskAction -Execute 'powershell.exe' -Argument '-WindowStyle Hidden -c python D:\sentiMation\generators\hypnotic_gen\hypnotic_generator.py' -WorkingDirectory 'D:\sentiMation\generators\hypnotic_gen'
