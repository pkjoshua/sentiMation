...
$taskAction = New-ScheduledTaskAction -Execute "powershell.exe" -Argument "-WindowStyle Hidden -c python $repoPath\generators\music\call.py" -WorkingDirectory "$repoPath\generators\music"
