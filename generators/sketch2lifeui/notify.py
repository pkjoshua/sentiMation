...
def send_pushover_notification(message):
    ...
    image_path = "assets/inputs/input_image.jpg"
    ...
    files = {
        "attachment": ("input_image.jpg", open(image_path, "rb"), "image/png")
    }
...
# Example usage
send_pushover_notification("Sketch2Lifeui generation process completed.")
