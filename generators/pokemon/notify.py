...
def send_pushover_notification(message):
    ...
    image_path = "current_pokemon.png"
    ...
    files = {
        "attachment": ("current_pokemon.png", open(image_path, "rb"), "image/png")
    }
...
# Example usage
send_pushover_notification("Whos that Pokemon generation process completed.")
