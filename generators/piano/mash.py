...
TXT_FONT = 'Freestyle-Script'  # or the exact name of the font as installed on your system
...
# Define text clip with wrapping
    txt_clip = TextClip(wrapped_text, fontsize=TXT_FONTSIZE, color=TXT_COLOR, font=TXT_FONT, align='West', method='label', size=(clip.size[0]-MARGIN, None))

    # Define an outline text clip (black color) slightly larger size
    txt_clip_outline = TextClip(wrapped_text, fontsize=TXT_FONTSIZE, color=TXT_OUTLINE_COLOR, font=TXT_FONT, align='West', method='label', size=(clip.size[0]-MARGIN, None))
